...
// makes sure the wstickerle site is loaded
...
//----------------------------------------------------
  ...
  $('.nav-block .nav, footer .nav').onePageNav({
    scrollThresstickerld: 0.2, // Adjust if Navigation highlights too early or too late
